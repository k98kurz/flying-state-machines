...
- `FSM`
  ...
  - `input(self, event: Enum|str, data: Any = None) -> Enum|str:`
   - `pack(self) -> bytes:`
   - `@classmethod unpack(data: bytes, inject: dict = {}, event_hooks: dict = {}, transition_hooks: dict = {}, random: Callable[[], float] = None) -> FSM:`
  - `touched(self) -> str:`
- `Transition`
...
As of v0.3.1, you can specify a custom random function for probabilistic
