...
- Use scripts/linechecker.py to check line lengths
...
- Start docstring on same line as opening quotation marks
...
from niceledger.reports import generate_report_in_process # internal, non-relative
import json # stdlib
import os # stdlib
